							...
							<view class="operator-wrapper">
								...
								<view class="module-info-box">
									...
									<view class="module-info-item">
										<text class="module-label">{{ $t('cellular.model')}}</text>
										<text class="module-value">{{ getModuleModel() }}</text>
									</view>
									<view class="module-info-item">
...
export default {
	...
	methods: {
		...
		getModuleModel() {
			...
			// 若没找到，尝试从 fullName 包含 model/name 的条目取值
			for (let item of sources) {
